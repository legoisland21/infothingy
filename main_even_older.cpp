...
void PrintCPUName() {
	...
	if (type == 0) cout << "ARCHITECTURE: x86" << endl;
	if (type == 5) cout << "ARCHITECTURE: ARM" << endl;
	if (type == 6) cout << "ARCHITECTURE: IA64" << endl;
	if (type == 9) cout << "ARCHITECTURE: x64" << endl;
	if (type == 12) cout << "ARCHITECTURE: ARM64" << endl;
}
